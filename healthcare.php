...
<head>
    ...
    <title>VirtuSwift - Health IT Solutions</title>
...
<body class="bg-gray-100">
    ...
    <!-- Health IT Solutions Section -->
    <section class="health-it-services-section bg-white">
        <!-- Slider Section -->
        <div class="relative w-full h-[400px] bg-gray-100 overflow-hidden">
            <div class="slider flex transition-transform duration-500 ease-in-out">
                <div class="slide min-w-full h-[400px] bg-cover bg-center"
                    style="background-image: url('https://images.unsplash.com/photo-1576091160399-112ba8d25d1d');">
                    <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-start px-10">
                        <div class="text-white">
                            <h1 class="text-4xl font-bold mb-4">Advance Healthcare with VirtuSwift IT Solutions</h1>
                            <p class="text-lg">Enhance patient care and streamline operations with innovative
                                technology.</p>
                        </div>
                    </div>
                </div>
                <div class="slide min-w-full h-[400px] bg-cover bg-center"
                    style="background-image: url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRzk5lw0TfGrPcG5I11cT-L10UHHjtF0stQvg&s');">
                    <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-start px-10">
                        <div class="text-white">
        ...
        <div class="container mx-auto px-4 py-8">
            ...
            <div id="Overview" class="tab-content">
                <div class="flex flex-col md:flex-row gap-8 mb-12">
                    <div class="md:w-1/2">
                        <h2 class="text-3xl font-bold mb-4">Transforming Healthcare with VirtuSwift IT Expertise</h2>
                        <p class="text-gray-600 mb-6">
                            At VirtuSwift, we deliver tailored IT solutions to revolutionize healthcare delivery.
                            Our expertise in EHR integration, telemedicine, and patient data analytics empowers
                            providers to enhance care and efficiency.
                        </p>
                        <a href="contact.php"
                    ...
                    <div class="md:w-1/2">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTb2naf1q4Hv1QU_X41qt7CGj4ZnE8ULTqgug&s"
                            alt="Health IT Technology" class="w-full h-64 object-cover rounded-lg">
                    </div>
                </div>
            </div>
            ...
            <div id="Capabilities" class="tab-content hidden">
                <div class="mb-12">
                    ...
                    <h2 class="text-3xl font-bold mb-4">Revolutionize Healthcare with VirtuSwift</h2>
                    <div class="space-y-8">
                        <div class="flex flex-col md:flex-row gap-6">
                            <div class="md:w-1/3">
                                <h4 class="text-lg font-semibold text-[#00AEEF]">EHRSync Platform</h4>
                                <p class="text-gray-600">Seamless integration of electronic health records for improved
                                    interoperability.</p>
                            </div>
                            <div class="md:w-1/3">
                                <h4 class="text-lg font-semibold text-[#00AEEF]">TeleHealth Dashboard</h4>
                                <p class="text-gray-600">Secure telemedicine solutions for remote patient consultations.
                                </p>
                            </div>
                            <div class="md:w-1/3">
                                <h4 class="text-lg font-semibold text-[#00AEEF]">Patient Data Analytics</h4>
                                <p class="text-gray-600">Actionable insights from patient data to enhance care outcomes.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="space-y-12 mt-12">
                <div class="flex flex-col md:flex-row gap-8">
                    <div class="md:w-1/2">
                        <h3 class="text-xl font-semibold mb-4">Proactive Support for Healthcare Excellence</h3>
                        <p class="text-gray-600 mb-4">
                            Our robust support system resolves 95% of health IT challenges swiftly, backed by continuous
                            training to address evolving healthcare needs.
                        </p>
                        <a href="contact.php"
                    ...
                    <div class="md:w-1/2">
                        <img src="https://s7ap1.scene7.com/is/image/TCSCOMprod/government-healthcare-it-solutions?wid=1100&hei=581&dpr=off"
                            alt="Health IT Support" class="w-full h-64 object-cover rounded-lg">
                    </div>
                </div>
                ...
                <div class="flex flex-col md:flex-row gap-8">
                    <div class="md:w-1/2">
                        ...
                        <p class="text-gray-600 mb-4">
                            ...
                            health IT solutions, improving patient outcomes and operational efficiency.
                        </p>
                        <a href="contact.php"
            ...
            <div class="container mx-auto px-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="bg-white p-4 rounded-lg shadow-sm">
                        <img src="https://images.unsplash.com/photo-1576091160399-112ba8d25d1d" alt="Resource 1"
                            class="w-full h-40 object-cover rounded-lg mb-4">
                        <h4 class="text-lg font-semibold text-[#00AEEF] mb-2">Health IT Insights</h4>
                        <p class="text-gray-600">Learn how VirtuSwift enhances healthcare with innovative IT solutions.
                        </p>
                    </div>
                    <div class="bg-white p-4 rounded-lg shadow-sm">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRAUF-8devljF9bxN4bWEVx9WHUNQEDUJwscg&s"
                        ...
                        <p class="text-gray-600">Discover strategies for improving patient care through technology.</p>
                    </div>
                    <div class="bg-white p-4 rounded-lg shadow-sm">
                        <img src="https://images.unsplash.com/photo-1600585154340-be6161a56a0c" alt="Resource 3"
                            class="w-full h-40 object-cover rounded-lg mb-4">
                        <h4 class="text-lg font-semibold text-[#00AEEF] mb-2">Whitepaper</h4>
                        <p class="text-gray-600">Why secure data analytics are critical for modern healthcare.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    if (mobileNavToggle) {
        mobileNavToggle.addEventListener('click', () => {
            nav_above.classList.toggle('active');
        });
    }
