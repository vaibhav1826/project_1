...
<head>
    ...
    <title>VirtuSwift - Azure Cloud Solutions</title>
...
<body class="bg-gray-100">
    ...
    <section class="azure-services-section bg-white">
        <!-- Slider Section -->
        <div class="relative w-full h-[400px] bg-gray-100 overflow-hidden">
            <div class="slider flex transition-transform duration-500 ease-in-out">
                <div class="slide min-w-full h-[400px] bg-cover bg-center"
                    style="background-image: url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQXRYeSIiXuxLcteoQz8uYRqestWZvepQROVc1JpR35--9gw52r5Evew8hUp19kjqm2O2I&usqp=CAU');">
                    <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-start px-10">
                        <div class="text-white">
                            <h1 class="text-4xl font-bold mb-4">Empower Your Business with VirtuSwift Azure Solutions
                            </h1>
                            <p class="text-lg">Unlock scalability, security, and innovation with Azure Cloud Services.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="slide min-w-full h-[400px] bg-cover bg-center"
                    style="background-image: url('https://adtimin.vn/wp-content/uploads/2024/12/Microsoft-Azure-la-gi.webp');">
                    <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-start px-10">
                        <div class="text-white">
        ...
        <div class="container mx-auto px-4 py-8">
            ...
            <div id="Overview" class="tab-content">
                <div class="flex flex-col md:flex-row gap-8 mb-12">
                    <div class="md:w-1/2">
                        <h2 class="text-3xl font-bold mb-4">Unleashing Azure Excellence: Scalability, Security,
                            Innovation</h2>
                        <p class="text-gray-600 mb-6">
                            At VirtuSwift, we tailor Azure Cloud Services to your unique business needs. Our solutions
                            are
                            built on scalability, security, and innovation, ensuring your cloud journey drives business
                            success.
                        </p>
                        <a href="contact.php"
                    ...
                    <div class="md:w-1/2">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSUBO3Slvb_SIxNdF1763zz3KTDKM63z8Lseg&s"
                            alt="Azure Technology" class="w-full h-64 object-cover rounded-lg">
                    </div>
                </div>
            </div>
            ...
            <div id="Capabilities" class="tab-content hidden">
                <div class="mb-12">
                    ...
                    <h2 class="text-3xl font-bold mb-4">Transform Your Business with Azure</h2>
                    <div class="space-y-8">
                        <div class="flex flex-col md:flex-row gap-6">
                            <div class="md:w-1/3">
                                <h4 class="text-lg font-semibold text-[#00AEEF]">Azure Monitor</h4>
                                <p class="text-gray-600">Real-time insights into your cloud infrastructure with advanced
                                    monitoring and analytics.</p>
                            </div>
                            <div class="md:w-1/3">
                                <h4 class="text-lg font-semibold text-[#00AEEF]">Cost Management</h4>
                                <p class="text-gray-600">Optimize your Azure spending with detailed cost analysis and
                                    budgeting tools.</p>
                            </div>
                            <div class="md:w-1/3">
                                <h4 class="text-lg font-semibold text-[#00AEEF]">Managed Services</h4>
                                <p class="text-gray-600">Ensure peak performance with our managed Azure solutions and
                                    support.</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="space-y-12 mt-12">
                <div class="flex flex-col md:flex-row gap-8">
                    <div class="md:w-1/2">
                        <h3 class="text-xl font-semibold mb-4">Proactive Azure Support</h3>
                    ...
                    <div class="md:w-1/2">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTEjDwsaJwB8c4e6OSyPnXe8Cl6e6NJLDBTIH3MMflKjA6hvb8p9jdrgevMBMK4eqAKYcY&usqp=CAU"
                ...
                <div class="flex flex-col md:flex-row gap-8">
                    <div class="md:w-1/2">
                        <h3 class="text-xl font-semibold mb-4">Strength Through Microsoft Partnerships</h3>
                        <p class="text-gray-600 mb-4">
                    ...
                    <div class="md:w-1/2">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRhTu8jlplpIVJqn1BZ3xUJ-kDEVg0jFZfcGQ&s"
            ...
            <div class="container mx-auto px-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="bg-white p-4 rounded-lg shadow-sm">
                        <img src="https://cdn.prod.website-files.com/64ad227a3e66387fc5d89320/65cc5760a73d6666440d87e3_seminars-training-header.jpg"
                        ...
                        <p class="text-gray-600">Discover how VirtuSwift transforms businesses with Azure solutions.</p>
                    </div>
                    <div class="bg-white p-4 rounded-lg shadow-sm">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRNK3yARCnDWMwzel5CanHdtCdCRMNhJ0eSOQ&s"
                        ...
                        <p class="text-gray-600">Learn how to optimize cloud costs with Azure tools.</p>
                    </div>
                    <div class="bg-white p-4 rounded-lg shadow-sm">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTIqMiwG51MRc0ePydC9gM0LEom0Pdlbh3zUA&s"
                            alt="Resource 3" class="w-full h-40 object-cover rounded-lg mb-4">
                        <h4 class="text-lg font-semibold text-[#00AEEF] mb-2">Thought Leadership</h4>
                        <p class="text-gray-600">Why businesses need Azure for scalable cloud infrastructure.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        if (message) {
            ...
            setTimeout(() => {
                ...
                responseElement.innerHTML =
                    `<div class="chat-message-bot">Thank you for your message. Our Azure team will assist you shortly.</div>`;
