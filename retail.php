...
<head>
    ...
    <title>VirtuSwift - Retail & E-commerce IT Solutions</title>
...
<body class="bg-gray-100">
    ...
    <!-- Retail and E-commerce Services Section -->
    <section class="retail-ecommerce-services-section bg-white">
        <!-- Slider Section -->
        <div class="relative w-full h-[400px] bg-gray-100 overflow-hidden">
            <div class="slider flex transition-transform duration-500 ease-in-out">
                <div class="slide min-w-full h-[400px] bg-cover bg-center"
                    style="background-image: url('https://media.licdn.com/dms/image/v2/D5612AQHuOR7hsNnU7w/article-cover_image-shrink_720_1280/article-cover_image-shrink_720_1280/0/1687089476754?e=2147483647&v=beta&t=C6ojpuKequkR-qY6X8He4k9pSfw4WqhvMpnA4EXgKAY');">
                    <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-start px-10">
                        <div class="text-white">
                            <h1 class="text-4xl font-bold mb-4">Transform Retail with VirtuSwift E-commerce Solutions
                            </h1>
                            <p class="text-lg">Enhance customer experiences and optimize operations with innovative IT.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="slide min-w-full h-[400px] bg-cover bg-center"
                    style="background-image: url('https://images.unsplash.com/photo-1506765515384-028b60a970df');">
                    <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-start px-10">
                        <div class="text-white">
        ...
        <div class="container mx-auto px-4 py-8">
            ...
            <div id="Overview" class="tab-content">
                <div class="flex flex-col md:flex-row gap-8 mb-12">
                    <div class="md:w-1/2">
                        <h2 class="text-3xl font-bold mb-4">Empowering Retail with VirtuSwift IT Innovation</h2>
                        <p class="text-gray-600 mb-6">
                            At VirtuSwift, we deliver tailored IT solutions to elevate retail and e-commerce businesses.
                            Our expertise in digital platforms and customer engagement ensures your brand thrives in a
                            competitive market.
                        </p>
                        <a href="contact.php"
                    ...
                    <div class="md:w-1/2">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSiuPTeAWRNYYrzopgXP5iLfY5oZ1invv-VqQ&s"
                            alt="Retail Technology" class="w-full h-64 object-cover rounded-lg">
                    </div>
                </div>
            </div>
            ...
            <div id="Capabilities" class="tab-content hidden">
                <div class="mb-12">
                    ...
                    <h2 class="text-3xl font-bold mb-4">Revolutionize Retail with VirtuSwift</h2>
                    <div class="space-y-8">
                        <div class="flex flex-col md:flex-row gap-6">
                            <div class="md:w-1/3">
                                <h4 class="text-lg font-semibold text-[#00AEEF]">CustomerSync Portal</h4>
                                <p class="text-gray-600">Real-time insights into customer behavior and preferences for
                                    personalized experiences.</p>
                            </div>
                            <div class="md:w-1/3">
                                <h4 class="text-lg font-semibold text-[#00AEEF]">Inventory Insights Dashboard</h4>
                                <p class="text-gray-600">Monitor stock levels and supply chain performance with advanced
                                    analytics.</p>
                            </div>
                            <div class="md:w-1/3">
                                <h4 class="text-lg font-semibold text-[#00AEEF]">E-commerce Integration</h4>
                                <p class="text-gray-600">Seamlessly connect online stores with payment gateways and CRM
                                    systems.</p>
                            </div>
                        </div>
                    </div>
            ...
            <div id="Benefits" class="tab-content hidden">
                <h2 class="text-3xl font-bold mb-8">A Seamless Retail Experience</h2>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="bg-gray-50 p-6 rounded-lg shadow-sm">
                        <i class="fas fa-cogs text-3xl text-[#00AEEF] mb-4"></i>
                        <h4 class="font-bold text-lg mb-2">Certified Experts</h4>
                        <p class="text-gray-600">Our team is skilled in leading e-commerce platforms and technologies.
                        </p>
                    </div>
                    <div class="bg-gray-50 p-6 rounded-lg shadow-sm">
                        <i class="fas fa-sync-alt text-3xl text-[#00AEEF] mb-4"></i>
                        <h4 class="font-bold text-lg mb-2">Proven Results</h4>
                        <p class="text-gray-600">We’ve empowered retail brands with successful digital transformations.
                        </p>
                    </div>
                    <div class="bg-gray-50 p-6 rounded-lg shadow-sm">
                        <i class="fas fa-graduation-cap text-3xl text-[#00AEEF] mb-4"></i>
                        <h4 class="font-bold text-lg mb-2">Continuous Learning</h4>
                        <p class="text-gray-600">Our experts stay ahead of retail tech trends and innovations.</p>
                    </div>
                    <div class="bg-gray-50 p-6 rounded-lg shadow-sm">
                        <i class="fas fa-cloud text-3xl text-[#00AEEF] mb-4"></i>
                        <h4 class="font-bold text-lg mb-2">Scalable Platforms</h4>
                        <p class="text-gray-600">Build e-commerce solutions that grow with your business.</p>
                    </div>
                    <div class="bg-gray-50 p-6 rounded-lg shadow-sm">
                        <i class="fas fa-shield-alt text-3xl text-[#00AEEF] mb-4"></i>
                        <h4 class="font-bold text-lg mb-2">Cost Optimization</h4>
                        <p class="text-gray-600">Maximize ROI with efficient IT solutions.</p>
                    </div>
                    <div class="bg-gray-50 p-6 rounded-lg shadow-sm">
                        <i class="fas fa-handshake text-3xl text-[#00AEEF] mb-4"></i>
                        <h4 class="font-bold text-lg mb-2">Trusted Partnerships</h4>
                        <p class="text-gray-600">Collaborate with top tech providers for cutting-edge solutions.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-12 mt-12">
                <div class="flex flex-col md:flex-row gap-8">
                    <div class="md:w-1/2">
                        <h3 class="text-xl font-semibold mb-4">Proactive Support for Retail Success</h3>
                        <p class="text-gray-600 mb-4">
                            Our comprehensive support system resolves 95% of e-commerce challenges swiftly, backed by
                            continuous training to address emerging retail trends.
                        </p>
                        <a href="contact.php"
                    ...
                    <div class="md:w-1/2">
                        <img src="https://images.unsplash.com/photo-1506765515384-028b60a970df" alt="Retail Support"
                ...
                <div class="flex flex-col md:flex-row gap-8">
                    <div class="md:w-1/2">
                        <h3 class="text-xl font-semibold mb-4">Strengthened by Industry Partnerships</h3>
                        <p class="text-gray-600 mb-4">
                            Since 2010, VirtuSwift has partnered with leading tech providers to deliver innovative
                            e-commerce and retail solutions, driving business growth.
                        </p>
                        <a href="contact.php"
                    ...
                    <div class="md:w-1/2">
                        <img src="https://sidgs.com/wp-content/uploads/2023/01/1500-x-914-Understanding-the-Impact-of-Digital-Transformation-in-Retail-and-Commerce.jpg"
            ...
            <div class="container mx-auto px-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="bg-white p-4 rounded-lg shadow-sm">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT38dIRAugXemCfkFq5aOQO_faZxKlWE_dXDA&s"
                            alt="Resource 1" class="w-full h-40 object-cover rounded-lg mb-4">
                        <h4 class="text-lg font-semibold text-[#00AEEF] mb-2">Retail Insights</h4>
                        <p class="text-gray-600">Learn how VirtuSwift enhances e-commerce with innovative IT solutions.
                        </p>
                    </div>
                    <div class="bg-white p-4 rounded-lg shadow-sm">
                        <img src="https://images.unsplash.com/photo-1506765515384-028b60a970df" alt="Resource 2"
                            class="w-full h-40 object-cover rounded-lg mb-4">
                        <h4 class="text-lg font-semibold text-[#00AEEF] mb-2">Webinar Replay</h4>
                        <p class="text-gray-600">Discover strategies for boosting online sales and customer loyalty.</p>
                    </div>
                    <div class="bg-white p-4 rounded-lg shadow-sm">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQfF52MfmW1YZljilk5n6fj2mMYEpjh9f0Ibg&s"
                        ...
                        <p class="text-gray-600">Why omnichannel retail is essential for modern businesses.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="chat-widget-container">
        ...
        <div id="chat-widget-popup" class="chat-widget-popup">
            <div class="chat-widget-header">
                ...
                <span id="chat-widget-close" class="chat-widget-close">&times;</span>
            </div>
