...
<head>
    ...
    <title>VirtuSwift - Salesforce Solutions</title>
    ...
    .nav-link::after {
        ...
        right: 16px;
        height: 3px;
        background-color: var仇--accent-color);
        transform: scaleX(0);
    ...
    .chat-widget-button {
        ...
        justify-content: center;
        cursor: pointer;
        box-shadow: 0 4px 15px rgbarape: 0 4px 12px rgba(0, 0, 0, 0.1);
        transition: transform 0.3s ease;
    }
...
<body class="bg-gray-100">
    ...
    <section class="salesforce-services-section bg-white">
                ...
                <div class="slide min-w-full h-[400px] bg-cover bg-center"
                    ...
                    <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-start px-10">
                        <div class="text-white">
                            <h1 class="text-4xl font-bold mb-4">Elevate Your Business with VirtuSwift Salesforce
                                Solutions</h1>
                            <p class="text-lg">Unlock customer success with innovative, scalable, and integrated CRM
                                solutions.</p>
                        </div>
                    </div>
                </div>
                <div class="slide min-w-full h-[400px] bg-cover bg-center"
                    style="background-image: url('https://images.pexels.com/photos/3184296/pexels-photo-3184296.jpeg');">
                    <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-start px-10">
                        <div class="text-white">
        ...
        <div class="container mx-auto px-4 py-8">
            <div id="Overview" class="tab-content">
                <div class="flex flex-col md:flex-row gap-8 mb-12">
                    <div class="md:w-1/2">
                        <h2 class="text-3xl font-bold mb-4">Mastering Salesforce: Innovation, Integration, Impact</h2>
                    ...
                    <div class="md:w-1/2">
                        <img src="https://images.pexels.com/photos/3184292/pexels-photo-3184292.jpeg"
                            alt="Salesforce Technology" class="w-full h-64 object-cover rounded-lg">
                    </div>
                </div>
            </div>
            ...
            <div id="Capabilities" class="tab-content hidden">
                <div class="mb-12">
                    ...
                    <h2 class="text-3xl font-bold mb-4">Revolutionize CRM with VirtuSwift</h2>
                    <div class="space-y-8">
                        <div class="flex flex-col md:flex-row gap-6">
                            <div class="md:w-1/3">
                                <h4 class="text-lg font-semibold text-[#00AEEF]">Customer 360 Portal</h4>
                                <p class="text-gray-600">Real-time insights into customer interactions with integrated
                                    data across platforms.</p>
                            </div>
                            <div class="md:w-1/3">
                                <h4 class="text-lg font-semibold text-[#00AEEF]">Einstein Analytics</h4>
                                <p class="text-gray-600">AI-driven insights to optimize sales, service, and marketing
                                    performance.</p>
                            </div>
                            <div class="md:w-1/3">
                                <h4 class="text-lg font-semibold text-[#00AEEF]">Managed Cloud Services</h4>
                                <p class="text-gray-600">Keep your Salesforce environment optimized with our expert
                                    support.</p>
                            </div>
                        </div>
                    </div>
            ...
            <div id="Benefits" class="tab-content hidden">
                <h2 class="text-3xl font-bold mb-8">A Modern Salesforce Experience</h2>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="bg-gray-50 p-6 rounded-lg shadow-sm">
                        <i class="fas fa-cogs text-3xl text-[#00AEEF] mb-4"></i>
                        <h4 class="font-bold text-lg mb-2">Expert Consultants</h4>
                        <p class="text-gray-600">Certified Salesforce professionals delivering tailored solutions.</p>
                    </div>
                    <div class="bg-gray-50 p-6 rounded-lg shadow-sm">
                        <i class="fas fa-sync-alt text-3xl text-[#00AEEF] mb-4"></i>
                        <h4 class="font-bold text-lg mb-2">Proven Success</h4>
                        <p class="text-gray-600">Trusted CRM implementations across diverse industries.</p>
                    </div>
                    <div class="bg-gray-50 p-6 rounded-lg shadow-sm">
                        <i class="fas fa-graduation-cap text-3xl text-[#00AEEF] mb-4"></i>
                        <h4 class="font-bold text-lg mb-2">Continuous Innovation</h4>
                        <p class="text-gray-600">Stay ahead with training on Salesforce’s latest features.</p>
                    </div>
                    <div class="bg-gray-50 p-6 rounded-lg shadow-sm">
                        <i class="fas fa-cloud text-3xl text-[#00AEEF] mb-4"></i>
                        <h4 class="font-bold text-lg mb-2">Efficient Processes</h4>
                        <p class="text-gray-600">Streamline operations with integrated Salesforce tools.</p>
                    </div>
                    <div class="bg-gray-50 p-6 rounded-lg shadow-sm">
                        <i class="fas fa-shield-alt text-3xl text-[#00AEEF] mb-4"></i>
                        <h4 class="font-bold text-lg mb-2">Cost Optimization</h4>
                        <p class="text-gray-600">Maximize ROI with efficient Salesforce deployments.</p>
                    </div>
                    <div class="bg-gray-50 p-6 rounded-lg shadow-sm">
                        <i class="fas fa-handshake text-3xl text-[#00AEEF] mb-4"></i>
                        <h4 class="font-bold text-lg mb-2">Trusted Partnerships</h4>
                        <p class="text-gray-600">Collaborate with Salesforce for cutting-edge solutions.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-12 mt-12">
                <div class="flex flex-col md:flex-row gap-8">
                    <div class="md:w-1/2">
                        <h3 class="text-xl font-semibold mb-4">Proactive Salesforce Support</h3>
            ...
            <div class="container mx-auto px-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="bg-white p-4 rounded-lg shadow-sm">
                        ...
                        <h4 class="text-lg font-semibold text-[#00AEEF] mb-2">CRM Insights</h4>
                        <p class="text-gray-600">Discover how VirtuSwift enhances customer engagement with Salesforce.
                        </p>
                    </div>
                    <div class="bg-white p-4 rounded-lg shadow-sm">
                        ...
                        <p class="text-gray-600">Learn strategies for maximizing Salesforce ROI.</p>
                    </div>
                    <div class="bg-white p-4 rounded-lg shadow-sm">
                        <img src="https://images.pexels.com/photos/3184296/pexels-photo-3184296.jpeg" alt="Resource 3"
                            class="w-full h-40 object-cover rounded-lg mb-4">
                        <h4 class="text-lg font-semibold text-[#00AEEF] mb-2">Industry Guide</h4>
                        <p class="text-gray-600">Why businesses need integrated CRM systems for growth.</p>
                    </div>
                </div>
            </div>
        </div>
