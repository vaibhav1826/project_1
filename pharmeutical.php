...
<head>
    ...
    <title>VirtuSwift - Pharmaceutical IT Solutions</title>
...
<body class="bg-gray-100">
    ...
    <!-- Pharmaceutical IT Solutions Section -->
    <section class="pharmaceutical-it-services-section bg-white">
        <!-- Slider Section -->
        <div class="relative w-full h-[400px] bg-gray-100 overflow-hidden">
            <div class="slider flex transition-transform duration-500 ease-in-out">
                <div class="slide min-w-full h-[400px] bg-cover bg-center"
                    style="background-image: url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTDwjiejWcMLZ-L-docGrTDXq1AZRMDDsYggg&s');">
                    <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-start px-10">
                        <div class="text-white">
                            <h1 class="text-4xl font-bold mb-4">Innovate Pharmaceuticals with VirtuSwift IT Solutions
                            </h1>
                            <p class="text-lg">Accelerate drug development and ensure compliance with advanced
                                technology.</p>
                        </div>
                    </div>
                </div>
                <div class="slide min-w-full h-[400px] bg-cover bg-center"
                    style="background-image: url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRbnNXvGSg7N2iin7PY9_l4a73ZbqTwMpChQA&s');">
                    <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-start px-10">
                        <div class="text-white">
        ...
        <div class="container mx-auto px-4 py-8">
            ...
            <div id="Overview" class="tab-content">
                <div class="flex flex-col md:flex-row gap-8 mb-12">
                    <div class="md:w-1/2">
                        <h2 class="text-3xl font-bold mb-4">Transforming Pharmaceuticals with VirtuSwift IT Expertise
                        </h2>
                        <p class="text-gray-600 mb-6">
                            At VirtuSwift, we deliver tailored IT solutions to advance pharmaceutical innovation.
                            Our expertise in drug development analytics, regulatory compliance, and clinical trial
                            management empowers companies to accelerate research and ensure quality.
                        </p>
                        <a href="contact.php"
                    ...
                    <div class="md:w-1/2">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTsIeHfKkebf_2Yqm7OJFuRgz-3QJCJqWoPTw&s"
                            alt="Pharmaceutical IT Technology" class="w-full h-64 object-cover rounded-lg">
                    </div>
                </div>
            </div>
            ...
            <div id="Capabilities" class="tab-content hidden">
                <div class="mb-12">
                    ...
                    <h2 class="text-3xl font-bold mb-4">Revolutionize Pharmaceuticals with VirtuSwift</h2>
                    <div class="space-y-8">
                        <div class="flex flex-col md:flex-row gap-6">
                            <div class="md:w-1/3">
                                <h4 class="text-lg font-semibold text-[#00AEEF]">PharmaAnalytics Platform</h4>
                                <p class="text-gray-600">Advanced analytics for drug development and clinical trial
                                    optimization.</p>
                            </div>
                            <div class="md:w-1/3">
                                <h4 class="text-lg font-semibold text-[#00AEEF]">ReguCompliance Dashboard</h4>
                                <p class="text-gray-600">Streamlined regulatory compliance with automated reporting
                                    tools.</p>
                            </div>
                            <div class="md:w-1/3">
                                <h4 class="text-lg font-semibold text-[#00AEEF]">TrialSync Solutions</h4>
                                <p class="text-gray-600">Efficient management of clinical trials with real-time data
                                    integration.</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="space-y-12 mt-12">
                <div class="flex flex-col md:flex-row gap-8">
                    <div class="md:w-1/2">
                        <h3 class="text-xl font-semibold mb-4">Proactive Support for Pharmaceutical Innovation</h3>
                        <p class="text-gray-600 mb-4">
                            Our robust support system resolves 95% of pharma IT challenges swiftly, backed by continuous
                            training to address evolving industry regulations.
                        </p>
                        <a href="contact.php"
                    ...
                    <div class="md:w-1/2">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSNGrV5hyf8AoceMsaQfmbPxv0jSd0dgP2uFKuNTgqgeeMn8aF7Qx6wLdmojML52PhBf-o&usqp=CAU"
                            alt="Pharma IT Support" class="w-full h-64 object-cover rounded-lg">
                    </div>
                </div>
                ...
                <div class="flex flex-col md:flex-row gap-8">
                    <div class="md:w-1/2">
                        ...
                        <p class="text-gray-600 mb-4">
                            ...
                            pharmaceutical IT solutions, enhancing drug development and compliance.
                        </p>
                        <a href="contact.php"
                    ...
                    <div class="md:w-1/2">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQg3R2X2ymGJv8PWVzgySDFo405_d9e_Vh0Aw&s"
            ...
            <div class="container mx-auto px-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="bg-white p-4 rounded-lg shadow-sm">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTTJMUUxvdkfTla4AeToOp70QaEyMv322WKyIx9HIRhlTqOrnnWfRVTP4KWPTq5PqeuZlE&usqp=CAU"
                            alt="Resource 1" class="w-full h-40 object-cover rounded-lg mb-4">
                        <h4 class="text-lg font-semibold text-[#00AEEF] mb-2">Pharma IT Insights</h4>
                        <p class="text-gray-600">Learn how VirtuSwift accelerates drug development with innovative IT
                            solutions.</p>
                    </div>
                    <div class="bg-white p-4 rounded-lg shadow-sm">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcThJF7PNXtXi6CaQ_1MqTrG_KiURpkMjeHAEg&s"
                        ...
                        <p class="text-gray-600">Discover strategies for streamlining clinical trials and compliance.
                        </p>
                    </div>
                    <div class="bg-white p-4 rounded-lg shadow-sm">
                        <img src="https://kms-healthcare.com/wp-content/uploads/2022/01/22.png" alt="Resource 3"
                            class="w-full h-40 object-cover rounded-lg mb-4">
                        <h4 class="text-lg font-semibold text-[#00AEEF] mb-2">Whitepaper</h4>
                        <p class="text-gray-600">Why data analytics are critical for modern pharmaceutical innovation.
                        </p>
                    </div>
                </div>
            </div>
