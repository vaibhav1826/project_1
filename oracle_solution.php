...
<head>
    ...
    <title>VirtuSwift - Oracle Solutions</title>
    ...
    .chat-widget-button(Read more: https: //chat.openai.com/chat) button {
        width: 60px;
        height: 60px;
        border-radius: 30px;
...
<body class="bg-gray-100">
    ...
    <section class="oracle-solutions-section bg-white">
        <!-- Slider Section -->
        <div class="relative w-full h-[400px] bg-gray-100 overflow-hidden">
            <div class="slider flex transition-transform duration-500 ease-in-out">
                <div class="slide min-w-full h-[400px] bg-cover bg-center"
                    style="background-image: url('https://agiletec.in/images/portfolio/oracle-technologies.jpg');">
                    <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-start px-10">
                        <div class="text-white">
                            <h1 class="text-4xl font-bold mb-4">Transform Your Business with VirtuSwift Oracle Solutions
                            </h1>
                            <p class="text-lg">Drive innovation with Oracle’s cloud and on-premises solutions.</p>
                        </div>
                    </div>
                </div>
                <div class="slide min-w-full h-[400px] bg-cover bg-center"
                    style="background-image: url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS8JTOoZpftw-pBSnrxvmNy4iiJumdMMTsX0sG2WMOzBA_cHqXPvQ4jomexXs-EDC5F6Pk&usqp=CAU');">
                    <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-start px-10">
                        <div class="text-white">
        ...
        <div class="container mx-auto px-4 py-8">
            ...
            <div id="Overview" class="tab-content">
                <div class="flex flex-col md:flex-row gap-8 mb-12">
                    <div class="md:w-1/2">
                        <h2 class="text-3xl font-bold mb-4">Unleashing Oracle Excellence: Innovation, Scalability,
                            Expertise</h2>
                        <p class="text-gray-600 mb-6">
                            At VirtuSwift, we leverage Oracle’s comprehensive suite of cloud and on-premises solutions
                            to drive your digital transformation. Our tailored Oracle Solutions, including Oracle Cloud
                            Infrastructure (OCI) and integrated cloud applications, ensure seamless data management,
                            advanced analytics, and scalability for global enterprises.
                        </p>
                        <a href="contact.php"
                    ...
                    <div class="md:w-1/2">
                        <img src="https://agiletec.in/images/portfolio/oracle-technologies.jpg" alt="Oracle Technology"
            ...
            <div id="Capabilities" class="tab-content hidden">
                <div class="mb-12">
                    ...
                    <h2 class="text-3xl font-bold mb-4">Transform Operations with Oracle Solutions</h2>
                    <div class="space-y-8">
                        <div class="flex flex-col md:flex-row gap-6">
                            <div class="md:w-1/3">
                                <h4 class="text-lg font-semibold text-[#00AEEF]">Autonomous Database</h4>
                                <p class="text-gray-600">Leverage Oracle’s self-managing database for streamlined
                                    operations and enhanced performance.</p>
                            </div>
                            <div class="md:w-1/3">
                                <h4 class="text-lg font-semibold text-[#00AEEF]">Integration Cloud</h4>
                                <p class="text-gray-600">Seamlessly connect applications and data across cloud and
                                    on-premises environments.</p>
                            </div>
                            <div class="md:w-1/3">
                                <h4 class="text-lg font-semibold text-[#00AEEF]">Advanced Analytics</h4>
                                <p class="text-gray-600">Unlock actionable insights with Oracle’s powerful BI and
                                    analytics tools.</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="space-y-12 mt-12">
                <div class="flex flex-col md:flex-row gap-8">
                    <div class="md:w-1/2">
                        ...
                        <p class="text-gray-600 mb-4">
                            Our Oracle Solution Center offers comprehensive support, covering 95% of potential issues
                            with documented solutions for rapid resolution. Our team undergoes regular training to
                            address emerging Oracle challenges.
                        </p>
                        <a href="contact.php"
                    ...
                    <div class="md:w-1/2">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRozJLI2N6tg621Frye9QPz6ri-jhF1jbmf0w&s"
                ...
                <div class="flex flex-col md:flex-row gap-8">
                    <div class="md:w-1/2">
                        ...
                        <p class="text-gray-600 mb-4">
                            Since 2010, VirtuSwift has excelled in managing Oracle workloads across cloud and
                            on-premises models, partnering with Oracle to deliver innovative, scalable solutions.
                        </p>
                        <a href="contact.php"
            ...
            <div class="container mx-auto px-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="bg-white p-4 rounded-lg shadow-sm">
                        <img src="https://agiletec.in/images/portfolio/oracle-technologies.jpg" alt="Resource 1"
                            class="w-full h-40 object-cover rounded-lg mb-4">
                        <h4 class="text-lg font-semibold text-[#00AEEF] mb-2">Thought Leadership</h4>
                        <p class="text-gray-600">How VirtuSwift transforms enterprises with Oracle Cloud Infrastructure.
                        </p>
                    </div>
                    <div class="bg-white p-4 rounded-lg shadow-sm">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT-d5H4hUhIJb-dILQfc4fcYZlMFO1vKLrJAq1oC26wbHiCfCYWl19iIozhCGk1hsoHKC0&usqp=CAU"
                        ...
                        <p class="text-gray-600">Optimizing operations with Oracle Cloud Applications.</p>
                    </div>
                    <div class="bg-white p-4 rounded-lg shadow-sm">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS8JTOoZpftw-pBSnrxvmNy4iiJumdMMTsX0sG2WMOzBA_cHqXPvQ4jomexXs-EDC5F6Pk&usqp=CAU"
                        ...
                        <p class="text-gray-600">Enhancing scalability with Oracle’s Autonomous Database.</p>
                    </div>
                </div>
            </div>
        </div>
